...
function PropertyEmenities() {
  ...
  const dispatch = useDispatch()
    const checked = [
        ...
        {title:'Balcony', input: <input type="checkbox"  onChange={()=>dispatch(setBalcony())} checked={balcony}  className="group size-5 rounded-md bg-blue-700 p-1 ring-1 ring-white/15 ring-inset data-[checked]:bg-blue-700"/>},
